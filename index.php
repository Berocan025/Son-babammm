        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-item animate-on-scroll">
                    ...
                    <div class="stat-number" data-count="<?php echo $stat_projects; ?>"><?php echo $stat_projects; ?>+</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-item animate-on-scroll">
                    ...
                    <div class="stat-number" data-count="<?php echo $stat_clients; ?>"><?php echo $stat_clients; ?>+</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-item animate-on-scroll">
                    ...
                    <div class="stat-number" data-count="<?php echo $stat_years; ?>"><?php echo $stat_years; ?>+</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-item animate-on-scroll">
                    ...
                    <div class="stat-number" data-count="<?php echo $stat_awards; ?>"><?php echo $stat_awards; ?>+</div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="project-card animate-on-scroll">
                            ...
                            <div class="project-overlay">
                                <div class="project-links">
                                    <?php if($project['demo_url']): ?>
                                        <a href="<?php echo htmlspecialchars($project['demo_url']); ?>" target="_blank" title="Kanal">
                                            <i class="fab fa-telegram"></i>
                                        </a>
                                    <?php endif; ?>
                                    <?php if($project['github_url']): ?>
                                        <a href="<?php echo htmlspecialchars($project['github_url']); ?>" target="_blank" title="Chat">
                                            <i class="fab fa-telegram"></i>
                                        </a>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="project-desc"><?php echo truncateText($project['description'], 120); ?></div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge bg-gradient text-white"><?php echo htmlspecialchars($project['category']); ?></span>
                                <a href="portfolio.php" class="btn btn-outline-gradient btn-sm">İncele</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="product-card animate-on-scroll">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-description"><?php echo truncateText($product['description'], 150); ?></div>
                            
                            <div class="product-links mb-3">
                                <a href="products.php" class="btn btn-gradient btn-sm w-100">
