...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $telegram_username = clean($_POST['telegram_username']);
    $subject = clean($_POST['subject']);
    $message = clean($_POST['message']);
    
    if (!empty($name) && !empty($email) && !empty($telegram_username) && !empty($message)) {
        if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
            try {
                $stmt = $pdo->prepare("INSERT INTO contact_messages (name, email, telegram_username, subject, message) VALUES (?, ?, ?, ?, ?)");
                if ($stmt->execute([$name, $email, $telegram_username, $subject, $message])) {
        ...
        <div class="row">
            <div class="col-lg-8 mb-5">
                <div class="contact-form animate-on-scroll">
                    ...
                    <form method="POST" id="contactForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="telegram_username" class="form-label">Telegram Kullanıcı Adınız <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="telegram_username" name="telegram_username" required 
                                       placeholder="@kullaniciadi" 
                                       value="<?php echo isset($_POST['telegram_username']) ? htmlspecialchars($_POST['telegram_username']) : ''; ?>">
                            </div>
                            <div class="col-md-6 mb-3">
            ...
            <div class="col-lg-4">
                <div class="contact-info animate-on-scroll">
                    ...
                    <?php if(getSetting('contact_telegram')): ?>
                    <div class="contact-item mb-4">
                        <div class="d-flex align-items-start">
                            <div class="contact-icon me-3">
                            ...
                            <div>
                                <h5>Telegram</h5>
                                <p class="text-muted mb-0">
                                    <a href="<?php echo getSetting('contact_telegram'); ?>" target="_blank" class="text-decoration-none">
                                        <?php echo getSetting('contact_telegram_username', '@beratk'); ?>
                                    </a>
                                </p>
                            </div>
                        </div>
                    ...
                    <?php if(getSetting('contact_marketing')): ?>
                    <div class="contact-item mb-4">
                        <div class="d-flex align-items-start">
                            <div class="contact-icon me-3">
                            ...
                            <div>
                                <h5>Marketing</h5>
                                <p class="text-muted mb-0">
                                    <?php echo getSetting('contact_marketing'); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contact-item mb-4">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h5>Teams</h5>
                                <p class="text-muted mb-0">
                                    <?php echo getSetting('contact_teams', 'Profesyonel ekip toplantıları için Teams üzerinden görüşme ayarlayabilirsiniz.'); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="social-links-contact mt-4">
                        ...
                        <div class="d-flex gap-3">
                            <?php if(getSetting('social_youtube')): ?>
                                <a href="<?php echo getSetting('social_youtube'); ?>" target="_blank" class="social-link-contact">
                                    <i class="fab fa-youtube"></i>
                                </a>
                            <?php endif; ?>
                            <?php if(getSetting('social_telegram')): ?>
                                <a href="<?php echo getSetting('social_telegram'); ?>" target="_blank" class="social-link-contact">
                                    <i class="fab fa-telegram"></i>
                                </a>
                            <?php endif; ?>
                            <?php if(getSetting('social_facebook')): ?>
                                <a href="<?php echo getSetting('social_facebook'); ?>" target="_blank" class="social-link-contact">
