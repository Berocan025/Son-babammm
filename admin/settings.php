    ...
    elseif (isset($_POST['update_contact_settings'])) {
        try {
            ...
            if (isset($_POST['contact_telegram'])) {
                setSetting('contact_telegram', clean($_POST['contact_telegram']));
            }
            if (isset($_POST['contact_telegram_username'])) {
                setSetting('contact_telegram_username', clean($_POST['contact_telegram_username']));
            }
            if (isset($_POST['contact_marketing'])) {
                setSetting('contact_marketing', clean($_POST['contact_marketing']));
            }
            if (isset($_POST['contact_teams'])) {
                setSetting('contact_teams', clean($_POST['contact_teams']));
            }
            if (isset($_POST['telegram_link'])) {
                setSetting('telegram_link', clean($_POST['telegram_link']));
            }
    ...
    elseif (isset($_POST['update_social_settings'])) {
        try {
            if (isset($_POST['social_youtube'])) {
                setSetting('social_youtube', clean($_POST['social_youtube']));
            }
            if (isset($_POST['social_telegram'])) {
                setSetting('social_telegram', clean($_POST['social_telegram']));
            }
            if (isset($_POST['social_facebook'])) {
                setSetting('social_facebook', clean($_POST['social_facebook']));
            }
                    ...
                    <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-light"><i class="fab fa-telegram me-2"></i>Telegram Link</label>
                                        <input type="url" class="form-control" name="contact_telegram" value="<?php echo htmlspecialchars($settings['contact_telegram']); ?>" placeholder="https://t.me/username">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-light">Telegram Kullanıcı Adı</label>
                                        <input type="text" class="form-control" name="contact_telegram_username" value="<?php echo htmlspecialchars($settings['contact_telegram_username']); ?>" placeholder="@username">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-light">Ürünler İçin Telegram Link</label>
                                        <input type="url" class="form-control" name="telegram_link" value="<?php echo htmlspecialchars($settings['telegram_link']); ?>" placeholder="https://t.me/username">
                                        <small class="text-muted">Ürünler sayfasında Telegram butonu için kullanılacak</small>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-light"><i class="fas fa-bullhorn me-2"></i>Marketing</label>
                                    <textarea class="form-control" name="contact_marketing" rows="2"><?php echo htmlspecialchars($settings['contact_marketing']); ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-light"><i class="fab fa-microsoft me-2"></i>Teams</label>
                                    <textarea class="form-control" name="contact_teams" rows="2"><?php echo htmlspecialchars($settings['contact_teams']); ?></textarea>
                                </div>
                            ...
                            <div class="tab-pane fade" id="nav-social" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-light"><i class="fab fa-youtube me-2"></i>YouTube</label>
                                        <input type="url" class="form-control" name="social_youtube" value="<?php echo htmlspecialchars($settings['social_youtube']); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-light"><i class="fab fa-telegram me-2"></i>Telegram</label>
                                        <input type="url" class="form-control" name="social_telegram" value="<?php echo htmlspecialchars($settings['social_telegram']); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-light"><i class="fab fa-facebook me-2"></i>Facebook</label>
                                        <input type="url" class="form-control" name="social_facebook" value="<?php echo htmlspecialchars($settings['social_facebook']); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
