                    ...
                    <div class="col-lg-4 col-md-6 mb-4 portfolio-item animate-on-scroll <?php echo htmlspecialchars($project['category']); ?>">
                        <div class="project-card">
                            ...
                            <div class="p-4">
                                ...
                                <div class="project-desc text-muted mb-3"><?php echo truncateText($project['description'], 120); ?></div>
...
function showProjectDetails(projectId) {
    ...
    if (project) {
        ...
        let links = '';
        if (project.demo_url) {
            links += `<a href="${project.demo_url}" target="_blank" class="btn btn-gradient me-2"><i class="fab fa-telegram me-2"></i>Kanal</a>`;
        }
        if (project.github_url) {
            links += `<a href="${project.github_url}" target="_blank" class="btn btn-outline-gradient"><i class="fab fa-telegram me-2"></i>Chat</a>`;
        }
