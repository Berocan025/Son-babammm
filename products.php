                        ...
                        <div class="product-card animate-on-scroll">
                            ...
                            <div class="product-content">
                                ...
                                <div class="product-price mb-3">
                                    <span class="price-text text-gradient fw-bold fs-4">
                                ...
                                <div class="product-links mb-3">
                                    <?php if($product['demo_url']): ?>
                                        <a href="<?php echo htmlspecialchars($product['demo_url']); ?>" target="_blank" class="btn btn-outline-gradient btn-sm">
                                            <i class="fab fa-telegram me-1"></i>Grup
                                        </a>
                                    <?php endif; ?>
                                    <?php if($product['admin_demo_url']): ?>
                                        <a href="<?php echo htmlspecialchars($product['admin_demo_url']); ?>" target="_blank" class="btn btn-gradient btn-sm">
                                            <i class="fab fa-telegram me-1"></i>Kanal
                                        </a>
                                    <?php endif; ?>
                                </div>
                                
                                <div class="telegram-contact mb-3">
                                    <a href="<?php echo getSetting('telegram_link', 'https://t.me/beratk'); ?>?text=Merhaba! <?php echo urlencode($product['title']); ?> ürünü hakkında bilgi almak istiyorum." 
                                       target="_blank" class="btn btn-info btn-sm w-100">
                                        <i class="fab fa-telegram me-1"></i>Telegram ile İletişime Geç
                                    </a>
                                </div>
